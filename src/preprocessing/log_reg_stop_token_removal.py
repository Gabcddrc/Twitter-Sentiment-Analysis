## Removing non-discriminatory stop token determined by analysing the given
## dataset and filtering for frequent token with almost equal probability of
## occuring in positive or negative tweet.
...
def main():
    ...
    experiment.set_name("Custom Stop Token Removal")
    ...
    metrics = {
        ...
        "num_stop_token_removed": stop_token_remover.get_metric(),
    }
